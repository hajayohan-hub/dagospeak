...
export class TeacherAvatar {
  ...
  show(tipKey) {
    const tips = {
      ...
      'practice': { fr: "Suivez les étapes guidées : Écoutez, Répondez, Prononcez. Le bouton vert vous guide !", mg: "Araho ny dingana voatarika : Mihainoa, Valiako, Mitenena. Ny bokotra maitso dia mitarika anao !" },
      'dialogues': { fr: "Lisez la conversation et écoutez chaque ligne. Vous êtes prêt pour le Role Play !", mg: "Vakio ny resaka ary mihainoa ny andalana tsirairay. Vonona ianao ho an'ny Role Play !" },
      'roleplay': { fr: "Jouez les deux rôles. Écoutez, puis parlez à votre tour. Les réponses sont affichées pour vous aider.", mg: "Milalao anjara asa roa. Mihainoa, ary mitenena ianao. Ny valiny dia aseho mba hanampiana anao." },
      'challenge': { fr: "Défi ! Parlez sans voir les réponses. Si vous bloquez, retournez au Role Play Guidé.", mg: "Fanamby ! Mitenena tsy mijery ny valiny. Raha very ianao, miverina amin'ny Role Play Guidé." }
    };
  ...
  render() {
    ...
    avatar.addEventListener('click', () => {
      ...
      if (tooltip.style.display === 'block') this.speak(this.currentTip.fr);
    });
