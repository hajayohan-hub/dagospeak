 ...
 * 6 slides : Bienvenue, Méthode, Offres, Formulaire, Setup, Démarrer
 */
export class OnboardingScreen {
  ...
  #updateSlide() {
    ...
    if (slide.isFormSlide) {
      ...
      this.#renderFinalSlide(slide, visualContent, backButton);
    } else {
      this.#renderStandardSlide(slide, visualContent, backButton, skipButton);
    }
  ...
  #renderFinalSlide(slide, visualContent, backButton) {
    this.#container.innerHTML = `
      <div class="ob-logo">DS</div>
      ${backButton}
      <div style="max-width: 500px; width: 100%; animation: obFadeInUp 0.6s ease-out;">
  ...
  #renderStandardSlide(slide, visualContent, backButton, skipButton) {
    this.#container.innerHTML = `
      <div class="ob-logo">DS</div>
      ${backButton}
      ${skipButton}
